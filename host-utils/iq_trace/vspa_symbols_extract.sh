...
/home/nxp/Freescale/VSPA/VSPA_Tools_vbeta_14_00_781/bin/vspa-elfdump -y $1 > $1.symbol.txt
touch $1_vspa_exported_symbols_addr.txt
while read in; do
...
echo "#define IQ_PLAYER_ELD_VERSION \""$eld_md5sum"\"" >> $2
